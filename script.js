document.addEventListener('DOMContentLoaded', () => {
    ...
    const surveyQuestions = [
        ...
        { id: 19, type: 'matrix', question: "Selama satu tahun terakhir ini, seberapa sering guru melakukan hal-hal berikut?", rows: ["Memberikan masalah untuk didiskusikan", "Meminta diskusi kelompok mencari solusi", "Meminta merangkum hasil diskusi kelas", "Meminta merangkum teks bacaan", "Membantu mengaitkan bacaan dengan kehidupan", "Menjelaskan dengan diagram/peta pikiran", "Membandingkan isi bacaan", "Menghubungkan topik matematika dengan topik lain", "Menghubungkan matematika dengan mapel lain"], columns: ["Tidak Pernah", "Jarang", "Sering", "Sangat sering"], category: 'teaching_quality' },
        { id: 20, type: 'matrix', question: "Selama satu tahun terakhir ini, seberapa sering kamu mengalami hal berikut di kelas?", rows: ["Guru memberi tugas berbeda sesuai kecepatan siswa", "Siswa bisa berkonsultasi saat mengerjakan tugas", "Guru meminta siswa menjelaskan pemikirannya", "Guru melarang cara lain yang tidak diajarkan", "Guru menggunakan banyak contoh", "Guru menggunakan metode bervariasi", "Guru memperagakan materi agar lebih paham"], columns: ["Tidak pernah atau sangat jarang", "Di beberapa pelajaran", "Di sebagian besar pelajaran", "Di semua pelajaran"], category: 'teaching_quality' },
        { id: 21, type: 'matrix', question: "Bagaimana pendapatmu mengenai hal-hal berikut ini?", rows: ["Siswa berkebutuhan khusus sulit diajak bekerja sama", "Siswa berkebutuhan khusus memiliki kelebihan unik"], columns: ["Sangat Tidak Setuju", "Tidak Setuju", "Setuju", "Sangat Setuju"], category: 'inclusivity' },
        { id: 22, type: 'matrix', question: "Bagaimana perasaanmu ketika berinteraksi dengan siswa berkebutuhan khusus?", rows: ["Kamu merasa tertarik untuk berinteraksi", "Kamu merasa takut saat berinteraksi"], columns: ["Sangat Tidak Sesuai", "Tidak Sesuai", "Sesuai", "Sangat Sesuai"], category: 'inclusivity' },
        { id: 23, type: 'matrix', scenario: 'Bayangkan situasi: Guru memperkenalkan siswa baru berkebutuhan khusus dan menanyakan siapa yang mau duduk sebangku dengannya.', question: "Seberapa besar kemungkinan Kamu merasakan hal berikut?", rows: ["Bersemangat", "Stres"], columns: ["Sangat tidak mungkin", "Tidak mungkin", "Mungkin", "Sangat mungkin", "Pasti"], category: 'inclusivity' },
        { id: 25, type: 'matrix', question: "Terkait situasi siswa baru berkebutuhan khusus, seberapa setuju Kamu dengan pernyataan berikut?", rows: ["Kamu akan menawarkan diri menjadi teman sebangku", "Siswa tersebut sepertinya akan sulit menyesuaikan diri"], columns: ["Sangat Tidak Setuju", "Tidak Setuju", "Setuju", "Sangat Setuju"], category: 'inclusivity' },
        { id: 26, type: 'matrix', question: "Coba pikirkan tentang sekolahmu. Seberapa kamu setuju atau tidak setuju dengan pernyataan-pernyataan berikut?", rows: ["Kamu merasa betah di Sekolah", "Kamu merasa dikucilkan di sekolah"], columns: ["Sangat Tidak Setuju", "Tidak Setuju", "Setuju", "Sangat Setuju"], category: 'school_climate' },
        { id: 27, type: 'matrix', question: "Seberapa sesuai hal-hal berikut ini dengan keadaan sekolahmu?", rows: ["Guru tidak mengetahui ada kelompok siswa yang sering mengancam", "Para siswa merasa aman di lorong-lorong sekolah"], columns: ["Sangat Tidak Sesuai", "Tidak Sesuai", "Sesuai", "Sangat Sesuai"], category: 'school_climate' }
    ];
